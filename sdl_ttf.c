...
extern zend_class_entry *get_php_sdl_surface_ce(void);
extern zend_bool sdl_surface_to_zval(SDL_Surface *surface, zval *zval);
extern SDL_Surface *zval_to_sdl_surface(zval *z_val);
