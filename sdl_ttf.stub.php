...
function TTF_SizeUNICODE(TTF_Font $font, string $text, int &$w, int &$h): int {};
...
function TTF_RenderUNICODE_Solid(TTF_Font $font, string $text, SDL_Color $fg): SDL_Surface {};
...
function TTF_RenderUNICODE_Shaded(TTF_Font $font, string $text, SDL_Color $fg, SDL_Color $bg): SDL_Surface {};
...
function TTF_RenderUNICODE_Blended(TTF_Font $font, string $text, SDL_Color $fg): SDL_Surface {};
...
function TTF_RenderUNICODE_Blended_Wrapped(TTF_Font $font, string $text, SDL_Color $fg, int $wrapLength): SDL_Surface {};
